...
ggplot(rpd, aes(year, n, color = drug)) + 
  ...
  geom_text(data = filter(rpd, year == 2015),
            ...
            vjust = -1.25,
            fontface = "bold") +
  geom_vline(xintercept = 2009.25, color = "#9e8d71", linetype = "dotted", size = .6) +
  geom_vline(xintercept = 2012.8, color = "#9e8d71", linetype = "dotted", size = .6) +
  annotate("text", label = "End of\n'War on Drugs'", x = 2009.25, y = 525, color = "#9e8d71", size = 3) +
  annotate("text", label = "Marijuana 1st\nLeagalized", x = 2012.8, y = 525, color = "#9e8d71", size = 3) +
...
* change scale of ridges to to get less overlap - see jittered points better
...
* HOW TO CHANGE COLOR OF POINTS VS LINE
...
ggplot(pud1, aes(use_yr, fct_reorder(drug, use_yr), fill = drug)) +
  ...
  labs(x = "Years using prescription",
       title = "Common Addictive Benzodiazepine Prescription Use in U.S",
       subtitle = "Comparing 2001 use to 2015 use") +
