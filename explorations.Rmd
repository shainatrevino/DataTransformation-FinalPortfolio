...
library(nhanesA)
library(naniar)
##added libraries I needed to run this
library(here)
library(rio)
library(colorblindr)
library(ggridges)
...
```{r initial_plot1}
#not sure what all your variable abbreviations mean, might be helpful for labels of some sort for the lay person reading your code
h_count <- d %>% 
  group_by(year) %>% 
  count(heroin) %>% 
  filter(heroin == "Yes")
...
(2) For your code, it would have been helpful to label what your abbreviations mean (I commented this earlier) because, though I could figure out a few, I couldn't figure out all of them.
